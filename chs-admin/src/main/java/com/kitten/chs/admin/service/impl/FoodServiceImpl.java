...
public class FoodServiceImpl implements FoodService {
    ...
    public Response<?> addFood(AddFoodReqVO reqVO) {
        ...
        FoodDO foodDO = FoodDO.builder()
                ...
                .calories(reqVO.getCalories() != null ? reqVO.getCalories() : 0)
                .protein(reqVO.getProtein())
                .fat(reqVO.getFat())
                .carbohydrate(reqVO.getCarbohydrate())
                .healthTags(reqVO.getHealthTags())
    ...
    public Response<?> updateFood(UpdateFoodReqVO reqVO) {
        ...
        FoodDO updateFood = FoodDO.builder()
                ...
                .calories(reqVO.getCalories() != null ? reqVO.getCalories() : existingFood.getCalories())
                .protein(reqVO.getProtein() != null ? reqVO.getProtein() : existingFood.getProtein())
                .fat(reqVO.getFat() != null ? reqVO.getFat() : existingFood.getFat())
                .carbohydrate(reqVO.getCarbohydrate() != null ? reqVO.getCarbohydrate() : existingFood.getCarbohydrate())
                .healthTags(reqVO.getHealthTags() != null ? reqVO.getHealthTags() : existingFood.getHealthTags())
